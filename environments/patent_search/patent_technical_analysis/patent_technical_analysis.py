...
class PatentTechnicalEnvConfig(vf.EnvConfig):
    taskset: PatentTechnicalTasksetConfig
...
def load_environment(config: PatentTechnicalEnvConfig) -> vf.Env:
    return vf.Env(
