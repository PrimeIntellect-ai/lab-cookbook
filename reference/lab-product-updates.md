...
- Rename `prime lab sync --no-agent` to `--skip-agent` for naming consistency with `--skip-docs`. The cookbook reference page already documents the new name (`reference/lab-configuration.md`).
